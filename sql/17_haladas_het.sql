-- ============================================================
-- 17_haladas_het.sql — A Haladás függvény FRISS változata külön
-- fájlban (heti kártya: tavalyi TELJES hét; előrendelés bruttón).
-- Ezt futtasd, ha a kártya még a régi értékeket mutatja.
-- ============================================================
